...
window.CodeMirror = (function () {
    ...
    function CodeMirror(place, options) {
        ...
        //xhrObj.open('GET', options.url + "code-mirror.css", false);
        //xhrObj.send('');


        //var scriptEl = document.createElement('style');
        //scriptEl.innerHTML = xhrObj.responseText;
        ...
        // 	fileref.setAttribute("href", options.url+"code-mirror.css");
...
(function () {
    ...
    function scriptHint(editor, keywords, getToken, options) {
        ...
        while (tprop.type == "property") {
            ...
            if (tprop.string == ')') {
                ...
                if (tprop.type.indexOf("variable") === 0 || tprop.type.indexOf("property") === 0){
                    tprop.type = "function";
                }
                else {
                    return;
    ...
    var javascriptKeywords = ("component Wix console alert setTimeout break case catch continue debugger default delete do else false finally for function " +
    ...
    function getCompletions(token, context, keywords, options) {
        ...
        if (context) {
            ...
            if (obj.type.indexOf("variable") === 0 ||  obj.type.indexOf("function") === 0) {
