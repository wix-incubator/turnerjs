define.experiment.newAnimationEditorPart('SlideIn.AnimationNewBehaviors', function(){
    return {
        iconUrl: 'animation/icon-animation-slidein.png',
            displayName: 'ANIMATION_NAME_SLIDEIN',
        previewParams: {
        duration: 0.5,
            params: {
            direction: 'left'
