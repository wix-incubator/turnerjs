define.experiment.newAnimationEditorPart('TextRollIn.AnimationText', function(){
    return{
        iconUrl: 'animation/icon-animation-text-rollin.png',
        displayName: 'ANIMATION_NAME_TEXT_ROLLIN',
        previewParams: {
            duration: 1
        },
