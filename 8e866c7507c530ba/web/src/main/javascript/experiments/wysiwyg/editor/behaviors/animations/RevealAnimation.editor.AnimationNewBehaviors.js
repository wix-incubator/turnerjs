define.experiment.newAnimationEditorPart('Reveal.AnimationNewBehaviors', function(){
    return {
        iconUrl: 'animation/icon-animation-reveal.png',
        displayName: 'ANIMATION_NAME_REVEAL',
        previewParams: {
            duration: 0.7,
            params: {
                direction: 'left'
            ...
            params_direction: {
                type: 'ComboBox',
                    ...
                    list: [
                        ...
                        {value: 'center', label: 'ANIMATION_CONTROL_DIRECTION_FROM_CENTER'},
