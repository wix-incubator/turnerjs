define.experiment.newSkin('wysiwyg.common.components.facebooklikebox.viewer.skins.FacebookLikeBoxSkin.NewFacebookLikebox', function(skinDefinition){
    ...
    def.css([
        ...
        '%iframe% { border:none; box-sizing:border-box; width:100%; height:100%; overflow-x: hidden; overflow-y: scroll }',
