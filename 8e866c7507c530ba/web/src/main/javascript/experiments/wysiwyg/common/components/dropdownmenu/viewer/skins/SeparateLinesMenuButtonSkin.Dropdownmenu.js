define.experiment.skin('wysiwyg.common.components.dropdownmenu.viewer.skins.SeparateLinesMenuButtonSkin.Dropdownmenu', function(skinDefinition, experimentStrategy){
    ...
    def.iconParams({'description': 'Separator-buttons Lines Menu', 'iconUrl': '/images/wysiwyg/skinIcons/menu/menuseperatelines.png', 'hidden': false, 'index': 11});
    ...
    def.css([
        ...
        '%.color% {[trans] [shd] [pos] border-top: [brw] solid [brd]; border-bottom: [brw] solid [brd]; position: absolute;}',
        ...
        ' .subMenu {[rd] [shd] min-width: calc(100% - ([pad] * 2)); min-width: -webkit-calc(100% - ([pad] * 2)); z-index: 1; overflow: hidden;}',
        ' .subMenu li %.gap% {padding: 0; overflow: hidden; position: relative;}',
        ' .subMenu li %.bg% {padding: 5px 15px;}',
        ' .subMenu li %.color% {[bgDrop] border-radius: 0; border-width: 0; border-width: 0;}',
