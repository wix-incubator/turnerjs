define.experiment.skin('wysiwyg.common.components.dropdownmenu.viewer.skins.ShinyMenuIButtonSkin.Dropdownmenu', function(skinDefinition, experimentStrategy){
    ...
    def.css([
        ' .strip {[shd] [rd] background:transparent url([tdr]shiny1button_bg.png) center center repeat-x; [bg] width: 100%; min-height: inherit; position: absolute; top: 0; right: 0; bottom: 0; left: 0; display: table; box-sizing: border-box;}',
        ...
        '%menuContainer% > li {margin: 0; background:transparent url([tdr]shiny1button_bg.png) center center repeat-x; [bg] [trans] border-left: 1px solid [sep]; display: table-cell; vertical-align: middle; position: relative; height: 100%;}',

        '%menuContainer% > li:first-child {border-left: 0 solid transparent;}',
        ...
        ' .subMenu li {border-top: 0px solid transparent; padding: 5px 15px; background-color: transparent;}',
        ' .subMenu li:hover {background:transparent url([tdr]shiny1button_bg.png) center center repeat-x; [bgh] [trans]}',
        ' .subMenu li.selected {background:transparent url([tdr]shiny1button_bg.png) center center repeat-x; [bgs]}',
        ...
        '[state~="text-align-left"] li {text-align: left; left: 0;}',
        '[state~="text-align-center"] li {text-align: center;}',
        '[state~="text-align-right"] li {text-align: right; right: 0;}',
