define.experiment.skin('wysiwyg.common.components.dropdownmenu.viewer.skins.SeparateShinyIMenuButtonSkin.Dropdownmenu', function(skinDefinition, experimentStrategy){
    ...
    def.iconParams({'description': 'Separate Shiny-Buttons Menu I', 'iconUrl': '/images/wysiwyg/skinIcons/menu/menubuttonsshiny.png', 'hidden': false, 'index': 8});
    ...
    def.css([
        ...
        '%.shade% {[rd] background: url([tdr]shiny1button_bg.png) center center repeat-x; position: absolute; top: 0; bottom: 0; left: 0; right: 0;}',
        '%menuContainer% > li:hover > %.gap% %.shade% {background: url([tdr]shiny1button_bg.png) center center repeat-x;}',
        '%menuContainer% > li.selected > %.gap% %.shade% {background: url([tdr]shiny1button_bg.png) center center repeat-x;}',
        '%menuContainer% > li.selected:hover > %.gap% %.shade% {background: url([tdr]shiny1button_bg.png) center center repeat-x;}',
        ...
        ' .subMenu li:hover %.shade% {background: url([tdr]shiny1button_bg.png) center center repeat-x; border-radius: 0;}',
        ' .subMenu li.selected %.shade% {background: url([tdr]shiny1button_bg.png) center center repeat-x; border-radius: 0;}',
        ' .subMenu li.selected:hover %.shade% {background: url([tdr]shiny1button_bg.png) center center repeat-x;}',
