define.experiment.skin('wysiwyg.common.components.dropdownmenu.viewer.skins.ShinyMenuIIButtonSkin.Dropdownmenu', function(skinDefinition, experimentStrategy){
    ...
    def.css([
        ' .strip {[shd] [rd] background: url([tdr]shiny2button_bg.png) center top repeat-x, url([tdr]shiny2button_bg.png) center bottom repeat-x; [bg] width: 100%; min-height: inherit; position: absolute; top: 0; right: 0; bottom: 0; left: 0; display: table; box-sizing: border-box;}',
        'ul {cursor: pointer; list-style: none; padding: 0; margin: 0; white-space: nowrap; position: absolute;}',
        'li {background: url([tdr]shiny2button_bg.png) center top repeat-x, url([tdr]shiny2button_bg.png) center bottom repeat-x; [bg] [trans] margin: 0; padding: 0; box-sizing: border-box;}',
        'li:hover {[bgh] [trans]}',
        'li.selected {[bgs]}',
        ...
        ' .subMenu li {border-bottom: 0px solid transparent; background: none; padding: 5px 15px; background-color: transparent;}',
        ' .subMenu li:hover {background: url([tdr]shiny2button_bg.png) center top repeat-x, url([tdr]shiny2button_bg.png) center bottom repeat-x; [bgh] [trans]}',
        ' .subMenu li.selected {background: url([tdr]shiny2button_bg.png) center top repeat-x, url([tdr]shiny2button_bg.png) center bottom repeat-x; [bgs]}',
