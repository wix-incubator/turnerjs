define.experiment.newAnimation('TitleOne.AnimationText', function() {
    return {
        ...
        animate: function(element, duration, delay, params) {
            ...
            return this._animations.sequence([
                ...
                this._animations.applyTween('BaseFade', letters, speed.duration, delay, {to: {opacity: 1}, ease: 'Back.easeOut', stagger: speed.stagger}),
                ...
                this._animations.applyTween('BaseRotate3D', letters, speed.duration, delay, {from: {rotationX: 180, transformOrigin: "0 50% -50px"}, ease: 'Back.easeOut', stagger: speed.stagger, immediateRender: false})
            ], params);
        },
