define.skin('wysiwyg.common.components.verticalmenu.viewer.skins.VerticalMenuSeparatedButtonSkin', function(skinDefinition){
    ...
    def.iconParams({'description': 'Separated Buttons', 'iconUrl': 'images/wysiwyg/skinIcons/verticalmenu/seperatedButtons.jpg', 'hidden': false, 'index': 3});
