define.component('wysiwyg.common.components.inputs.OptionsListInput', function (componentDefinition) {
    ...
    def.methods({
        ...
        _getItemByIndex: function(index){
            return this.items && this.items[index] && this.items[index].getLogic();
        },
        setSelectedItemByIndex: function(index){
            this._changeSelectedItem(this._getItemByIndex(index));
        }
    });
});