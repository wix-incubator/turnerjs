define.skin('wysiwyg.common.components.dropdownmenu.viewer.skins.SeparateIndentedMenuButtonSkin', function(SkinDefinition) {
    ...
    def.iconParams({'description': 'Separate Indented Menu', 'iconUrl': '/images/wysiwyg/skinIcons/menu/separateindented.png', 'hidden': false, 'index': 16});
