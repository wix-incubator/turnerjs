define.skin('wysiwyg.common.components.facebooklikebox.editor.skins.FacebookLikeBoxPanelSkin', function(skinDefinition) {
	...
	def.compParts({
        ...
        colorCombo:         { skin: Constants.PanelFields.ComboBox.skins["default"] },
        transparentBgChk:   { skin: Constants.PanelFields.CheckBox.skins["default"] },
        facesCB :           { skin: Constants.PanelFields.CheckBox.skins["default"] },
        streamCB:           { skin: Constants.PanelFields.CheckBox.skins["default"] },
        borderCB:           { skin: Constants.PanelFields.CheckBox.skins["default"] },
    ...
    def.html(
        '<div skinPart="content">' +
            ...
            '<fieldset>' +
                '<div class="fld combo" skinpart="colorCombo"></div>' +
                '<div class="fld chbx"  skinpart="transparentBgChk"></div>' +
            '</fieldset>' +
