define.skin('wysiwyg.common.components.dropdownmenu.viewer.skins.SeparateShinyIMenuButtonSkin', function(SkinDefinition) {
    ...
    def.iconParams({'description': 'Separate Shiny I Menu', 'iconUrl': '/images/wysiwyg/skinIcons/menu/menubuttonsshiny.png', 'hidden': false, 'index': 8});
