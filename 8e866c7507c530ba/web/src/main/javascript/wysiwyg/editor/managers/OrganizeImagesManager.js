define.Class('wysiwyg.editor.managers.OrganizeImagesManager', function (def) {
	def.resources([
		'topology',
		'scriptLoader',
		'W.Preview',
	...
	def.methods({
		...
		_newDialog: function () {
			...
			dialog.src = this.resources.topology.wysiwyg + "/html/external/OrganizeImages/index.html";
