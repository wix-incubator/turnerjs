/**
 * @author etai@wix.com
 * Note// do not edit this until lodash 3.0.0-pre is stable for production version.
 * Currently 2.4.1 is supposed to be the last version on the 2.x branch, and nothing else will be updated,
 * but I copied over the debounce function from 3.0.0 since it includes a useful cancel() method to cancel
 * the debounced function when destroying an object (i.e. you have a debounced function as a listener and you don't want it to run)
 */
