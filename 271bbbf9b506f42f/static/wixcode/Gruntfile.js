...
module.exports = function(grunt) {
  ...
  var config = {
    ...
    webpack: {
      debug: [require('./static/RMI/webpack.config.debug.js'), require('./webpack.config.debug.js')],
      min: [require('./static/RMI/webpack.config.min.js'), require('./webpack.config.min.js')]
    },
    replace: {
