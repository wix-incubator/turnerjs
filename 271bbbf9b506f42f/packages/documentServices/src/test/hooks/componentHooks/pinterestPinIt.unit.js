define([
    ...
    describe('pinterestPinIt hook', function () {
        ...
        function addComp(siteData, showOnAllPages) {
            ...
            siteData.addData({id: 'mockDataQuery', type: 'PinterestPinIt'}, pageId);
        }
        ...
        function fakeLikes(likes) {
            spyOn(utils.socialAPI, 'pinterest').and.callFake(function (url, callback) {
                callback(likes);
            });
        }
        ...
        function executeHook(ps, compPointer) {
            ...
            pinterestPinIt(ps, compPointer, {}, null, {}, parentPointer);
        }
