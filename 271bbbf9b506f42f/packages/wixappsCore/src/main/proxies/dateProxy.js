define(["siteUtils", "wixappsCore/proxies/mixins/textProxy", "wixappsCore/core/typesConverter"], function (siteUtils, textProxy, /** wixappsCore.typesConverter */typesConverter) {
     ...
     * See full documentation at http://kb.wixpress.com/display/wixapps/Date
     */
        ...
        return function(date, mask, utc) {
            ...
            var _ = utc ? "getUTC" : "get",
                ...
                flags = {
                    ...
                    ddddd: dF.i18n.dayNames[D].toUpperCase(),
                    m: m + 1,
                    mm: pad(m + 1),
                    mmm: dF.i18n.monthNames[m],
                    mmmm: dF.i18n.monthNames[m + 12],
                    mmmmm: dF.i18n.monthNames[m].toUpperCase(),
                    yy: String(y).slice(2),
                    yyyy: y,
                    h: H % 12 || 12,
                    hh: pad(H % 12 || 12),
    ...
    return {
        ...
        statics: {
            ...
            format: {type:'compProp', defaultValue: 'mmmm dd, yyyy'}
        },

        getFormattedDateString: function(data) {
            var format = this.getCompProp('format') || this.constructor.format.defaultValue;
            var dateString = data.iso || data;
            var date = new Date(dateString);

            // don't display formatted date for 'min-value' dates
            if (date.getTime() >= 0) {
        ...
        renderProxy: function () {
            ...
            var formattedText = this.createFormattedText(this.getFormattedDateString(data));
