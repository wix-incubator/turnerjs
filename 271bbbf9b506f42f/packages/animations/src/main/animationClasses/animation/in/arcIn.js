define(['lodash', 'animations/localTweenEngine/localTweenEngine'], function(_, tweenEngine) {
     ...
     * @returns {TimelineMax}
     */
    function arcIn(elements, duration, delay, params) {
        ...
        sequence.add(factory.animate('BaseFade', elements, duration, delay, {from: {opacity: 0}, to: {opacity: 1}, ease: 'Sine.easeInOut'}));
        ...
        _.forEach(elements, function(element) {
            ...
            sequence
                ...
                .add(factory.animate('BaseRotate3D', element, duration, delay, {from: rotate3DParams, perspective: 200, fallbackFor3D: false, ease: 'Sine.easeInOut'}), 0);
        });
    ...
    factory.registerAnimation('ArcIn', arcIn);
});
